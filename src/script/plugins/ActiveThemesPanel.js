...
gxp.plugins.ActiveThemeNode = Ext.extend(GeoExt.tree.LayerNode, {
    ...
    render: function (bulkRender) {
        ...
        gxp.plugins.ActiveThemeNode.superclass.renderX.call(this, bulkRender);
...
/**
 * NodeType: ga_activetheme
 */

// Ext.tree.TreePanel.nodeTypes.ga_activethemes = GeoExt.tree.LayerNode;
Ext.tree.TreePanel.nodeTypes.ga_activetheme = gxp.plugins.ActiveThemeNode;
 ...
 *
 */
gxp.plugins.ActiveThemesPanel = Ext.extend(Ext.tree.TreePanel, {
     ...
     */
    qtip_up: 'Mover arriba',

    /** api: config[qtip_down]
     *  default value is "Move down".
     */
    qtip_down: 'Mover abajo',

    /** api: config[qtip_opacity]
     *  default value is "Opacity".
     */
    qtip_opacity: 'Opacidad',

    /** api: config[qtip_remove]
     *  default value is "Remove layer from list".
     */
    qtip_remove: 'Eliminar de la lista',

    /** api: config[qtip_tools]
     *  default value is "Tools".
     */
    qtip_tools: 'Herramientas',

    /** api: config[contextMenu]
     *  Context menu (right-click) for layer nodes, for now instance of gxp.plugins.LayerNodeContextMenu. Default value is null.
     */
    contextMenu: null,
    ...
    initComponent: function () {
        ...
        if (this.contextMenu) {
            ...
            this.contextMenu = new gxp.plugins.LayerNodeContextMenu(cmArgs);
        }

        Ext.apply(this, options);
        gxp.plugins.ActiveThemesPanel.superclass.initComponent.call(this);
...
/** api: xtype = ga_activethemespanel */
Ext.reg('ga_activethemespanel', gxp.plugins.ActiveThemesPanel);