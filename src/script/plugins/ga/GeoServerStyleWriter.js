...
gxp.plugins.GeoServerStyleWriter = Ext.extend(gxp.plugins.StyleWriter, {
    ...
    assignStyles: function(defaultStyle, callback) {
        var styles = [];console.log(this.target.layerRecord.data.title);
        ...
        Ext.Ajax.request({
            method: "PUT",
            url: this.baseUrl + "/layers/" +
                this.target.layerRecord.data.title + ".json",
...
Ext.preg("ga_geoserverstylewriter", gxp.plugins.GeoServerStyleWriter);
