...
OpenLayers.Control.StyleFeature = OpenLayers.Class(OpenLayers.Control.Button, {
    ...
    initialize: function (layer, options) {
        ...
        this.title = 'Change feature styles';
    ...
    toggleStyleEditor: function () {
        if (!gxp || !gxp.VectorStylesDialog) {
            Ext.Msg.alert('Warning', 'Vector Layer style editing requires GXP with VectorStylesDialog');
            return;
        }

        var layerRecord = app.mapPanel.layers.getByLayer(this.layer);
